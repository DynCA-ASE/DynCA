...
public:
    ...
    bool iter_next(){
        ...
        if (iter_curbit < (uint)iter_curpos_msb){
...
public:
    ...
    void SetUpperLimit(long long limit);
    ...
    std::vector<std::vector<int>> &GetTestcaseSet() { return testcase_set_; }
...
private:
    ...
    pboccsat::PbOCCSATSolver *pbo_solver_;
